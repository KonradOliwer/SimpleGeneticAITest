 ...
 * @author KonradOliwer
 */
public class StrengtheningArmorAction extends Action {

    public static final int ACTION_ID = 9;
    public static final int ACTION_COST = 109;
    ...
    public StrengtheningArmorAction() {
    ...
    protected void effect(Actor user, Actor enemy) {
        user.getState().strengtheningArmorEndsIn = LAST;
    }
}
