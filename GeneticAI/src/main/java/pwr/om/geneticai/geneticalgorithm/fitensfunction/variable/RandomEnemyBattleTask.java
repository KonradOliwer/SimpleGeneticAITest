 ...
 * @author KonradOliwer
 */
public class RandomEnemyBattleTask extends BattleTask {

    RandomEnemyBattleTask(Battleground battleground, int populationStartIndex, int repeats, Actor[] actorsTested, Actor[] enemis, int size) {
    ...
    public static class Factory extends BattleTasksFactory {
        ...
        protected Callable getBattleTask(Actor[] actorsTested, Actor[] enemis, int populationStartIndex, int size) {
            return new RandomEnemyBattleTask(this.battleground, populationStartIndex, this.repeats, actorsTested, enemis, size);
        }
